...
export type ApplicationStatus = 'researching' | 'gate1_pending' | 'gate1_failed' | 'gate2_pending' | 'gate2_high_risk' | 'drafting' | 'gate3_pending' | 'draft_ready' | 'awaiting_approval' | 'submitted' | 'successful' | 'unsuccessful' | 'withdrawn';
export type GateRiskLevel = 'pass' | 'high_risk';
export type ApplicationOutcome = 'successful' | 'unsuccessful' | 'pending';
export type DocumentType = 'governance' | 'financial' | 'policy' | 'evidence' | 'questionnaire' | 'transcript' | 'correspondence' | 'draft' | 'impact_data' | 'other';
export type DocumentProcessingStatus = 'pending' | 'processed' | 'failed';
export type AgentType = 'head_coach' | 'va' | 'eligibility' | 'grant_writer' | 'ops_manager' | 'social_media' | 'social_value' | 'funder_intelligence' | 'impact_measurement';
export type TaskType = 'gate1_check' | 'gate2_check' | 'gate3_check' | 'funder_shortlist' | 'draft_application' | 'monday_summary' | 'create_content' | 'onboarding_sequence' | 'social_value_report' | 'impact_report' | 'funder_intelligence_update';
